    ...
    try {
      ...
      const embed = new EmbedBuilder()
        ...
        .addFields(
          ...
          { name: 'Required Columns', value: '• `question_variants`\n• `correct_answer_variants`', inline: true },
      ...
      await interaction.editReply('❌ Could not load corpus template file. Please contact an administrator.');
    }
